...
<div class="blog_container">
  ...
  <div class="blog_container_post">
    ...
    <?php foreach ($todosPostsCuriosidade as $post): ?>
      <div class="cada_post">
    ...
    <div class="container_paginacao">
      <?php for ($q = 1; $q <= $numeroDePaginas; $q++): ?>
        <div class="itemPaginacao <?php echo($pagAtual == $q) ? 'pagina_ativa' : ''; ?>"><a href="<?php echo BASE_URL; ?>home/curiosidade/?p=<?php echo $q; ?>"><?php echo $q; ?></a></div>
      <?php endfor; ?>
    </div>
